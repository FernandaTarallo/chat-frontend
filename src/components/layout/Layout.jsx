        ...
        return(
            <div class="body d-flex">
                ...
                <div class="w-100 d-flex flex-column ">
                    <div className="nav-box d-flex p-2 align-items-center justify-content-between">
                        <form>
                            <div className="input-group">
                                ...
                                <input type="text" className="form-control" id="search" placeholder="Pesquisa"/>
                            </div>
                        </form>
                    ...
                    <div className="content d-flex bd-highlight">
                        <div className="all-chat d-flex flex-column">
                            ...
                            <div class="d-flex flex-row flex-grow-1 bd-highlight">
                        ...
                        <div className="active-chat d-flex flex-column">
                            <div class="active-head d-flex align-items-center justify-content-center">Ativos</div>
                            <div class="flex-grow-1 bd-highlight">Flex item</div>
                        </div>
                    </div>
                </div>
